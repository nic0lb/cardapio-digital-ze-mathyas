import { db } from "../dados/firebase.js";
...
const TELEFONE_RESTAURANTE = "5585981251110";
...
function atualizarCarrinho() {
    ...
    cartCount.textContent = carrinho.reduce(
...
function renderCarrinhoDetalhado() {
    ...
    if (carrinho.length === 0) {
        ...
        container.innerHTML =
        "<p style='text-align:center;color:#888;padding:20px'>Seu carrinho está vazio.</p>";
